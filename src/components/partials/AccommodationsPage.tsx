            ...
            >
                ...
                <div className={"container__row"}>
                    <div className={"column column--flex-2"}>
                        ...
                        <p className={"text--no-margin"}>17200 N Laurel Park Dr, Livonia, MI 48152 - P: 734-462-2000</p>
                        <p>To book and receive this rate by phone use the information provided above, to book via the web go to the website, select the dates you'd like to stay and under "Special Rates" enter this code: <b>H9DZFUB</b></p>
                        <p className={"text--no-margin"}>Please book by <b>September 6th, 2019</b> to receive the group rate of $109. Just supply them with group <b>Choi Bird Wedding Room Block</b>, group rate includes free shuttle service to & from the venue.</p>

                        <hr/>

                        <p>You may also try this source <a target={"_blank"} href={"https://www.hotwire.com/hotels/results/Novi%252C%2520Michigan%252C%2520United%2520States%2520of%2520America/09-28-2019/09-29-2019/1/2/0"}>Hotwire</a> which as of 2019-07-23 had rooms for $77/per night. With this source you get a garunteed star rating and area at a highly discounted rate, you won't know the exact hotel though until you've booked the room. Please note: You will not have the free shuttle service using this option to and from the venue.</p>
                    </div>
